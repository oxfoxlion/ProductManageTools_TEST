...
const BUILTIN_TEMPLATES = [
  { id: "empty", name: "（空白）", entries: [] },
  {
    ...
    entries: [
      ...
      { slot: "custom_3", header: "#Transceiver Type" },
      { slot: "custom_4", header: "#Fiber Mode" },
      { slot: "custom_5", header: "#Transmission Distance" },
      { slot: "custom_6", header: "#Data Rate (Gbps)" },
      { slot: "custom_7", header: "Connector" },
      { slot: "custom_8", header: "Rx LOS" },
      { slot: "custom_9", header: "Dimension (HxWxD)" },
      { slot: "custom_10", header: "Max. Data Rate" },
      { slot: "custom_11", header: "Wavelength" },
      { slot: "custom_12", header: "Max. Cable Distance" },
      { slot: "custom_13", header: "Media" },
      { slot: "custom_14", header: "Optical Components" },
      { slot: "custom_15", header: "Transmitter Type" },
      { slot: "custom_16", header: "Receiver Type" },
      { slot: "custom_17", header: "Modulation" },
      { slot: "custom_18", header: "Extinction Ratio" },
      { slot: "custom_19", header: "Core Size" },
      { slot: "custom_20", header: "CDR (Clock and Data Recovery)" },
      { slot: "custom_21", header: "Power Consumption" },
      { slot: "custom_22", header: "TX Power" },
      { slot: "custom_23", header: "Power Budget" },
      { slot: "custom_24", header: "DOM/DDM Support" },
      { slot: "custom_25", header: "MTBF (SX)" },
      { slot: "custom_26", header: "Inbuilt FEC" },
      { slot: "custom_27", header: "Receiver Sensitivity" },
      { slot: "custom_28", header: "Receiver Overload" },
      { slot: "custom_29", header: "Bit Error Ratio (BER)" },
      { slot: "custom_30", header: "Minimum Receiver Power" },
      { slot: "custom_31", header: "Industrial Temperature Range" },
      { slot: "custom_32", header: "Commercial Temperature Range" },
      { slot: "custom_33", header: "Protocols" },
      { slot: "custom_34", header: "EMC" },
      { slot: "custom_35", header: "Application Field" },
      { slot: "custom_36", header: "Warranty" },
    ],
  },
  {
    id: "mtpmpo",
    ...
    entries: [
      ...
      { slot: "custom_4", header: "#Fiber Mode" },
      { slot: "custom_5", header: "Wavelength" },
      { slot: "custom_6", header: "#Polish Type" },
      { slot: "custom_7", header: "Polarity" },
      { slot: "custom_8", header: "MPO Connector IL" },
      { slot: "custom_9", header: "MPO Connector RL" },
      { slot: "custom_10", header: "MTP Connector IL" },
      { slot: "custom_11", header: "MTP Connector RL" },
      { slot: "custom_12", header: "LC Connector IL" },
      { slot: "custom_13", header: "LC Connector RL" },
      { slot: "custom_14", header: "Attenuation at 850nm" },
      { slot: "custom_15", header: "Attenuation at 1300nm" },
      { slot: "custom_16", header: "Attenuation at 1310nm" },
      { slot: "custom_17", header: "Attenuation at 1550nm" },
      { slot: "custom_18", header: "Insertion Loss" },
      { slot: "custom_19", header: "Return Loss" },
      { slot: "custom_20", header: "Fiber Count" },
      { slot: "custom_21", header: "Cable Outside Diameter (OD)" },
      { slot: "custom_22", header: "Breakout Outside Diameter (OD)" },
      { slot: "custom_23", header: "Operating Temperature" },
      { slot: "custom_24", header: "Storage Temperature" },
    ],
  },
  {
    id: "uniboot",
